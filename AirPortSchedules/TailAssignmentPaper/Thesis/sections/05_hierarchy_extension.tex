...
are comparable because they start from the same fleet state and apply the same
check hierarchy, even though one represents decisions algebraically and the
other evaluates them through timeline simulation.
