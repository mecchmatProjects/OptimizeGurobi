...
As noted in Section~\ref{sec:heuristic_ferry}, this representation does not
make the MILP switch an exact analogue of explicit heuristic ferry events. The
project implements Dijkstra and ACO on implicit transition graphs rather than
as separate explicit time-expanded network data structures.
