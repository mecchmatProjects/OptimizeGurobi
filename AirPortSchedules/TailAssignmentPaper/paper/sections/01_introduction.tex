...
\item \textbf{Constraint~(11) correction.}  We show that the cumulative-flight-
...
presents the maintenance-extended model, the Constraint~(11) correction, and
the induced interpretation updates for C5--C11 under the corrected basic model.
...
\Cref{sec:computational} reports the numeric C11 counterexample and the benchmarking results of the legacy and ordered models, and
