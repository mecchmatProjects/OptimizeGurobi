...
\begin{enumerate}
\item \textbf{Basic feasibility correction (C2--C3 / Khaled constraints (3)--(6)).}
...
basic TAP model and proves a C2--C3 corner-case correction closed by C4--C5.  \Cref{sec:maintenance}
