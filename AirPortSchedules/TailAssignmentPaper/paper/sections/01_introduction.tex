...
\item \textbf{Heuristic benchmark.}  We implement and evaluate two
  ...
  hierarchy. We compare coverage, cost, and runtime against the available MILP
  results. Because some heuristic runs leave flights unassigned, objective
  values and optimality gaps are reported only when coverage is comparable.
\end{enumerate}
