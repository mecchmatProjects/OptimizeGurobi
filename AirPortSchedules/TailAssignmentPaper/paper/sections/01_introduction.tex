...
\item \textbf{Event-based reformulation.}  The day-indexed hierarchy model
  above still repeats a calendar-day index across every maintenance
  variable. We give a complete, day-free reformulation of the same
...
full $\{A,B,C,D\}$ extension.  \Cref{sec:event_reformulation} gives the
day-free event-based reformulation of the same requirements and proves its
correctness directly.  \Cref{sec:computational} reports the
