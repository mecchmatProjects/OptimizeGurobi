...
Constraints~\eqref{eq:c0}--\eqref{eq:c3} are intended to encode both equipment
...
\begin{proposition}[Claimed in \citealt{khaled2018compact}, Proposition~1]
  Any feasible solution to \eqref{eq:c1}--\eqref{eq:c3} with
  $x_{ij}\in\{0,1\}$ corresponds to a
...
\paragraph{Corrected C0--C3 feasibility criterion.}
...
\paragraph{C5 — Overlap constraint.}
...
\begin{proposition}[\citealt{khaled2018compact}, Proposition~2]
  The original model \eqref{eq:obj}--\eqref{eq:c5} contains $n_f n_p$ binary
