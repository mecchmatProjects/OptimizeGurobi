...
Constraints~\eqref{eq:c9}--\eqref{eq:c11}, \eqref{eq:c14} remain structurally unchanged. C12 is inactive in the type-A-only model. Their
...
\eqref{eq:c1}--\eqref{eq:c3}, \eqref{eq:c4_overlap}, \eqref{eq:c8}--\eqref{eq:c11},
...
\begin{remark}[Implementation status]
  ...
  The computational study in \Cref{sec:computational} numerically confirms both Lemma~\ref{lem:c13_flaw}
