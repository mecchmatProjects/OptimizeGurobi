...
\begin{remark}[Implementation status]
  The legacy implementation in \texttt{src/model.py} currently constructs the
  endpoint-split inequalities~\eqref{eq:c13_new_a}--\eqref{eq:c13_new_b}; its
  output does not by itself certify the exact between-check bound. The
