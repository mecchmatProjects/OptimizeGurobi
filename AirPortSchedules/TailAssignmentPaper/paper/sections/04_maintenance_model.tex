...
For binary $y$, C12 is implied by C10; it is retained because it makes the
...
\subsection{Impact of corrected C2--C4 feasibility on C5--C13}
...
\paragraph{C9--C12.}
Constraints~\eqref{eq:c6}--\eqref{eq:c12} remain structurally unchanged. C7 is inactive in the type-A-only model. Their
