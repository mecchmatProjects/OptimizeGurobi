...
\begin{table}[t]
\centering\small
\caption{Empirical heuristic summary (to be filled from
  \texttt{results/tables/} after experiments run).}
...
Average gap vs.\ MILP (\%) & TBD & TBD & TBD \\
Max gap vs.\ MILP (\%)     & TBD & TBD & TBD \\
Avg.\ CPU (s)              & TBD & TBD & TBD \\
\bottomrule
\end{tabular}
\end{table}
