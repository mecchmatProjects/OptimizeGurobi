...
continuity (C2 of \citet{khaled2018compact}) and turn-time feasibility (C4).
...
\begin{proposition}[Claimed in \citealt{khaled2018compact}, Proposition~1]
  Any feasible solution to \eqref{eq:c1}--\eqref{eq:int} corresponds to a
...
\begin{example}[Feasible to \eqref{eq:c1}--\eqref{eq:int}, infeasible in practice]
  ...
  $1\ge x_{i_2j}=1$. Therefore~\eqref{eq:c1}--\eqref{eq:int} are feasible.
...
\begin{proposition}[\citealt{khaled2018compact}, Proposition~2]
  The original model \eqref{eq:obj}--\eqref{eq:int} contains $n_f n_p$ binary
  decision variables and $O(n_fn_p)$ constraints.
\end{proposition}
