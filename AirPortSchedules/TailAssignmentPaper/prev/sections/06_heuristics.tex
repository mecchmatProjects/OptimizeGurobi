...
We study three heuristic families in the present report.  The greedy+insertion
construction provides the main baseline (with two refinement variants: a
repair-style sweep and a bounded local-search sweep, both improving the same
initial solution before the final schedule is accepted).  The Dijkstra-based space-time
